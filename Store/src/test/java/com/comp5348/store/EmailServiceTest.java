...
import com.comp5348.store.service.EmailService;
...
public class EmailServiceTest {
    ...
    public void testSendDeliveryRequest() throws JsonProcessingException {
        ...
        verify(rabbitTemplate).convertAndSend(eq("email.request.queue"), jsonCaptor.capture());
// 验证发送的 JSON 字符串是否正确
        String capturedJson = jsonCaptor.getValue();
        EmailRequestDTO capturedRequest = objectMapper.readValue(capturedJson, EmailRequestDTO.class);
